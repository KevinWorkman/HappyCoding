...
HTML was released in 1993. In the early days of web development, there was no such thing as CSS! Styling was done with HTML tags like `<center>` and with attributes like `color` (as in `<font color="red">`). Layout was done using HTML `<table>` elements, which let you place content into a grid.
...
{% include codepen-new.html slug-hash="vYezaKY" height="250" autoplay=true %}
...
{% include codepen-new.html slug-hash="zYEJLzM" height="250" autoplay=true %}
...
{% include codepen-new.html slug-hash="NWaLLdL" height="280" autoplay=true %}
...
{% include codepen-new.html slug-hash="xxXaybr" height="125" autoplay=true %}
...
{% include codepen-new.html slug-hash="QWqVZjW" height="125" autoplay=true %}
...
{% include codepen-new.html slug-hash="rNGZqLj" height="200" autoplay=true %}
...
{% include codepen-new.html slug-hash="VwMGEWG" height=150 autoplay=true %}
...
{% include codepen-new.html slug-hash="NWaLOXq" height=150 autoplay=true %}
...
{% include codepen-new.html slug-hash="ZEXMmEv" height=150 autoplay=true %}
...
{% include codepen-new.html slug-hash="QWqVJNv" height=150 autoplay=true %}
...
{% include codepen-new.html slug-hash="VwMGVWw" height=200 autoplay=true %}
...
{% include codepen-new.html slug-hash="vYezQzG" height=200 autoplay=true %}
...
{% include codepen-new.html slug-hash="gOGdZMX" height=200 autoplay=true %}
...
When you make the parent div bigger, the red child only grows enough to fit its content, but stops growing after that because its `flex-grow` is `0`. The green child grows faster than the blue child, because their `flex-grow` properties are `2` and `1`.
...
This means you can set these properties and then not worry about the exact size of your content, or the user's browser window.

## Learning More

I covered the fundamentals of flexbox above, but there are other properties and values you can use. To learn more about them, check out [A Complete Guide to Flexbox on CSS Tricks](https://css-tricks.com/snippets/css/a-guide-to-flexbox/).
...
{% include codepen-new.html slug-hash="jOGQqaN" height=280 autoplay=true %}
...
{% include codepen-new.html slug-hash="ZEXmqMW" height=200 autoplay=true %}
...
{% include codepen-new.html slug-hash="ExwOdGm" height=200 autoplay=true %}
...
{% include codepen-new.html slug-hash="RwLqqrv" height=250 autoplay=true %}
...
{% include codepen-new.html slug-hash="RwLqdwq" height=250 autoplay=true %}
...
{% include codepen-new.html slug-hash="QWqJoaK" height=250 autoplay=true %}
...
{% include codepen-new.html slug-hash="xxXQOwj" height=250 autoplay=true %}

Using grid:

{% include codepen-new.html slug-hash="rNGQevW" height=250 autoplay=true %}

If you want a challenge, try implementing the holy grail layout with floats or blocks!
...
{% include codepen-new.html slug-hash="RwLqmBJ" height=200 autoplay=true %}
...
{% include codepen-new.html slug-hash="qBPQGqR" height=300 autoplay=true %}
