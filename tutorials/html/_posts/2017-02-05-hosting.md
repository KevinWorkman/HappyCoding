...
- [Amazon S3](https://aws.amazon.com/s3/) is a webhost that allows you to store files, including `.html` files that can be used as webpages. Here is a [guide on setting up website hosting using Amazon S3](http://docs.aws.amazon.com/AmazonS3/latest/dev/WebsiteHosting.html); see the Example Walkthroughs at the bottom. Here is a [quick start guide on creating a webpage with Amazon Route 53 and Amazon S3](https://console.aws.amazon.com/quickstart-website/new).
