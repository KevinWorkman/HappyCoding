...
Remember that you can select elemnts by **class** or **ID**, and differnt styles cascade (in other words, combine) to decide the final styling of an element. Learn more about CSS at [CSS Tutorials](/tutorials/html/css) or on [W3SChools](https://www.w3schools.com/css/) or [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS).
...
You can read more about creating variables at [Js - Creating variables - Tutorials](/tutorials/javascript/creating-variables).
