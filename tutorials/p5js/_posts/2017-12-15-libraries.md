...
When in doubt, Google and [Happy Coding forum](https://forum.happycoding.io) are your friends!
...
You can read more about Moment.js at [momentjs docs](http://momentjs.com/docs/), but the general idea is to start with a "hello world" program to help you understand how a library works, without worrying about making it work with any other code.
...
This code creates a sketch that uses Moment.js to format the time in six different languages, and p5.js to draw that to the screen. You can play with this example at [P5 JS - Kevin workman Sketches](https://editor.p5js.org/KevinWorkman/sketches/zqDJteEjt).

# p5.js Libraries

You can use almost any JavaScript library with p5.js, but some JavaScript libraries are  specifically built with p5.js in mind. You can view a list of them at [P5 JS libraries](https://p5js.org/libraries/).
...
For example, let's use the **p5.speech** library in a P5.js sketch. Start by looking at [the p5.js libraries page](https://p5js.org/libraries/) and find the p5.speech link, which takes you to the p5.speech homepage [idmnyu - P5 JS speech](https://idmnyu.github.io/p5.js-speech/).
...
You can play with this example [P5 JS - Kevin Workman sketches](https://editor.p5js.org/KevinWorkman/sketches/rfUqDn1ls).
