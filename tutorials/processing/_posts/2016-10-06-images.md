...
![resizing image](/tutorials/processing/images/images-9.png)
...
![sketch showing the pixel color](/tutorials/processing/images/images-5.gif)
...
- Take an image and apply a cutom filter to it.
