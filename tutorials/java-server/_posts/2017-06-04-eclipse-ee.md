...
The examples in these tutorials are packaged as Maven projects. You can view all of them [here](https://github.com/KevinWorkman/HappyCoding/tree/gh-pages/examples/java-server/java-server-example-projects).
