...
Tomcat is bundled as an `apache-tomcat` directory inside a `.zip` file, which you can download from [Tomcat - Apache download](https://tomcat.apache.org/download-10.cgi).
