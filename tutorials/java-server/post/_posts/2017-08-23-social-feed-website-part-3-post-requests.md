...
meta-image: /tutorials/java-server/images/social-feed-website-part-3-post-requests-4.png
...
![post form](/tutorials/java-server/images/social-feed-website-part-3-post-requests-1.png)

If you enter a name and a message and then click the `Send` button, you'll see your message added to the feed:

![message posted](/tutorials/java-server/images/social-feed-website-part-3-post-requests-2.png)
