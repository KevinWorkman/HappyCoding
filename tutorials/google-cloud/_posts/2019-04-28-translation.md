...
This value comes from [ISO 639](https://en.wikipedia.org/wiki/ISO_639), a standard for language names. A language code is a 2-letter abbreviation that stands for a specific language. You can view a full list on [Wikipedia](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes), but here are some examples:
