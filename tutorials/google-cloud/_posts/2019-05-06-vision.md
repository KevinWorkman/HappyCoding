...
You can view this example project [Github - KevinWorkman/HappyCoding - Google Cloud-Example-Vision](https://github.com/KevinWorkman/HappyCoding/tree/gh-pages/examples/google-cloud/google-cloud-example-projects/cloud-vision-hello-world-standalone), or download it as a `.zip` file from DownGit [Github - KevinWorkman/HappyCoding - Google Cloud-Example-Vision](https://downgit.github.io/#/home?url=https://github.com/KevinWorkman/HappyCoding/tree/gh-pages/examples/google-cloud/google-cloud-example-projects/cloud-vision-hello-world-standalone).
...
You can view this example project from [Github - KevinWorkman/HappyCoding - Google Cloud-Example-Vision-HelloWorld](https://github.com/KevinWorkman/HappyCoding/tree/gh-pages/examples/google-cloud/google-cloud-example-projects/cloud-vision-hello-world-webapp), or download it as a `.zip` file from DownGit [Github - KevinWorkman/HappyCoding - Google Cloud-Example-Vision-HelloWorld](https://downgit.github.io/#/home?url=https://github.com/KevinWorkman/HappyCoding/tree/gh-pages/examples/google-cloud/google-cloud-example-projects/cloud-vision-hello-world-webapp).
...
See the full `pom.xml` file [Github - KevinWorkman/HappyCoding - Google Cloud-Example-Vision-pom.xml](https://github.com/KevinWorkman/HappyCoding/blob/gh-pages/examples/google-cloud/google-cloud-example-projects/cloud-vision-hello-world-webapp/pom.xml).
