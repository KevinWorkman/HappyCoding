...
Are you thinking about selling your art in an online store like [Etsy - HappyCoding](https://www.etsy.com/shop/HappyCoding)? (Shameless self-promotion: that's my Etsy store.) This guide walks you through the process of creating and selling physical prints based on your digital art.
...
Register for a Printful account [Printful - register](https://www.printful.com/auth/register).
...
Go [Printful - order](https://www.printful.com/dashboard/order/update) to create an order. The Printful workflow generally works like this:
...
Register for an Etsy account [Etsy - join](https://www.etsy.com/join). This allows you to act as a customer on Etsy, and if you haven't used it before I recommend searching around to get a feel for it.

To sell your art, create an Esty store [Etsy - Sell](https://www.etsy.com/sell).
...
Create a product in Printful by going to the [Printful - store dashboard](https://www.printful.com/dashboard/default). Select a product, upload an image, set prices, and give it a title and a description. (You can edit these anytime, so don't worry too much about getting it exactly right.)
...
One thing I haven't mentioned is how you actually get customers to visit your listings. That's an entire industry full of books and so-called SEO experts. For now drop a link in the [happycoding forum](https://forum.happycoding.io) and you'll have at least one new fan.
