...
That didn't stop me from checking the [theme announcement](https://ldj.am/45). I saw that the theme was **start with nothing** and I went about my business. I finished my workday, biked home, ate dinner, and started playing [video games](https://en.wikipedia.org/wiki/Lego_Marvel_Super_Heroes_2) to try to relax.
...
Anyway, the name stuck, I deemed the game done enough, and I submitted my [entry](https://ldj.am/45/000000).
...
I'm also really happy with the feedback I received in the comments on my [entry](https://ldj.am/45/000000) page. This positive energy is one of the reasons I love Ludum Dare so much, and I definitely recommend everybody try it out at least once.
