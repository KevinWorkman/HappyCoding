...
function mousePressed(){
	...
	if(thumbnails[thumbnailIndex]){
	  ...
	  thumbnails[thumbnailIndex] = loadImage('http://s3.happycoding.io.s3-website-us-east-1.amazonaws.com/gallery/comic-book-colors/images/comics/' + comicName + '/thumbnails/' + comicName + '-thumbnail-' + thumbnailIndex.toString().padStart(3, '0') + '.png', redraw);
	}
	redraw();
	return false;
}
...
function loadComic(){
	averagesImage = loadImage('http://s3.happycoding.io.s3-website-us-east-1.amazonaws.com/gallery/comic-book-colors/images/comics/' + comicName + '/' + comicName + '-averages-1.png', redraw);
	
	select('#line-clusters').elt.src = 'http://s3.happycoding.io.s3-website-us-east-1.amazonaws.com/gallery/comic-book-colors/images/comics/' + comicName + '/' + comicName + '-line-clusters-1.png';
