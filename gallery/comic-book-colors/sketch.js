...
function mousePressed(){
	...
	if(thumbnails[thumbnailIndex]){
	  ...
	  thumbnails[thumbnailIndex] = loadImage('http://s3.amazonaws.com/s3.happycoding.io/gallery/comic-book-colors/images/comics/' + comicName + '/thumbnails/' + comicName + '-thumbnail-' + thumbnailIndex.toString().padStart(3, '0') + '.png', redraw);
	}
	redraw();
	return false;
}
...
function loadComic(){
	averagesImage = loadImage('http://s3.amazonaws.com/s3.happycoding.io/gallery/comic-book-colors/images/comics/' + comicName + '/' + comicName + '-averages-1.png', redraw);
